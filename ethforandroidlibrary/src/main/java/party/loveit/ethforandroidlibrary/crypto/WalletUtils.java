...
import static party.loveit.ethforandroidlibrary.crypto.Hash.sha256;
import static party.loveit.ethforandroidlibrary.crypto.Keys.ADDRESS_LENGTH_IN_HEX;
import static party.loveit.ethforandroidlibrary.crypto.Keys.PRIVATE_KEY_LENGTH_IN_HEX;
...
public class WalletUtils {
    ...
    private static String getWalletFileName(WalletFile walletFile) {
        ...
        return format.format(new Date()) + walletFile.getAddress() + ".json";
    }
